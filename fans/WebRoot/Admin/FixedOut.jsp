	...
	<div class="searchDiv">
		<form action="<%=path %>/FixedHandle" method="get">
			...
			<select name="condition">
				...
				<option value='user_name'>粉丝昵称</option>
				...
				out.write("<input type='hidden' name='hvalue' value='"+(request.getAttribute("value")!=null?request.getAttribute("value").toString():"")+"' />");
                		if(list!=null) //循环数据列表，生成表格行
                		{
                			for(int i=0;i<list.size();i++)
	                		{
	               				...
	               				String result=obj[4].toString().equals("1111-11-11")?"未下线":"已下线";
	               				out.print("<tr><td>"+obj[0]+"</td><td>"+obj[1]+"</td><td>"+obj[7]+"</td><td>"+obj[6]+"</td><td>"+obj[2]+" "+obj[3]+"</td><td>"+result+"</td><td><a href='"+path+"/FixedHandle?type=10&fixed_id="+obj[0]+"' class='a_del' onclick='return confirm(\"是否确认下线？\")'>设置下线</a></td></tr>");
	                		}
                		}
