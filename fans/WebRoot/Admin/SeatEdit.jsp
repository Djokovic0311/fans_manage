	...
	<%
	 ...
	 <form action="<%=path %>/SeatHandle?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>ID：</td><td><input type="text" name="seat_id" value="<%=obj[0] %>" readonly /></td></tr>
			 <tr><td>职位编号：</td><td><input type="text" name="seat_num" value="<%=obj[1] %>" required /></td></tr>
			 <tr><td>当前等级：</td><td>
			 ...
			 <tr><td>当前状态：</td><td>
			 	<select name="seat_state">
				      <%
				       ...
				       {
				      %>
				       <option value="0" selected="selected">空缺</option>
			 ...
			 <tr><td>备注：</td><td><input type="text" name="seat_tag" value="<%=obj[4] %>" /></td></tr>
