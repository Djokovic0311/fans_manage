	...
	<%
	 ...
	 <form action="<%=path %>/CardHandle?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>ID编号：</td><td><input type="text" name="card_id" value="<%=obj[0] %>" readonly /></td></tr>
			 <tr><td>职位编号：</td><td>
				<select name="seat_id">
				<%
				     Seat seat=new Seat();
			 ...
			 <tr><td>用户昵称：</td><td><input type="text" name="user_name" value="<%=obj[2] %>" /></td></tr>
			 <tr><td>用户性别：</td><td>
			 ...
			 <tr><td>注册时长：</td><td><input type="text" name="user_addr" value="<%=obj[4] %>" required /></td></tr>
			 <tr><td>活跃程度：</td><td><input type="text" name="car_num" value="<%=obj[5] %>" required /></td></tr>
