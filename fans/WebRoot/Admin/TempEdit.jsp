	...
	<%
	 ...
	 <form action="<%=path %>/TempHandle?type=2" method="post">
		<table style=" margin:50px auto;">
			 ...
			 <tr><td>活跃程度：</td><td><input type="text" name="car_num" value="<%=obj[2] %>" readonly="readonly" /></td></tr>
			 <tr><td>上线日期：</td><td><input type="text" name="entry_date" value="<%=obj[3] %>" readonly="readonly" /></td></tr>
			 <tr><td>上线时间：</td><td><input type="text" name="entry_time" value="<%=obj[4] %>" readonly="readonly" /></td></tr>
			 <tr><td>下线日期：</td><td><input type="text" name="out_date" value="" readonly="readonly" /></td></tr>
			 <tr><td>下线时间：</td><td><input type="text" name="out_time" value="" readonly="readonly" /></td></tr>
			 <tr><td>在线小时：</td><td><input type="text" name="time" value="" readonly="readonly" style="width:140px" /></td></tr>
			 <tr><td>平均贡献：</td><td><input type="text" name="price" value="3" style="width:140px" /></td></tr>
			 <tr><td>总贡献：</td><td><input type="text" name="temp_money" style="width:140px" value="<%=obj[7] %>"  readonly="readonly" /></td></tr>
		    </tbody>   
