	...
	<%
	 ...
	 <form action="<%=path %>/FixedHandle?type=2" method="post">
		<table style=" margin:50px auto;">
			 ...
			 <tr><td>ID：</td><td><input type="text" name="card_id" value="<%=obj[1] %>" /></td></tr>
			 <tr><td>上线日期：</td><td><input type="text" name="entry_date" value="<%=obj[2] %>" /></td></tr>
			 <tr><td>上线时间：</td><td><input type="text" name="entry_time" value="<%=obj[3] %>" /></td></tr>
			 <tr><td>下线日期：</td><td><input type="text" name="out_date" value="<%=obj[4] %>" /></td></tr>
			 <tr><td>下线时间：</td><td><input type="text" name="out_time" value="<%=obj[5] %>" /></td></tr>
