...
<body>
    ...
    <div class="wrap">
        <ul class="siderbar">
	        ...
	        <li><span>职位信息管理</span>
	            <ul>
	               <li><a href="<%=path %>/Admin/SeatAdd.jsp" target="mainFrame">添加职位信息</a></li>
	               <li><a href="<%=path %>/SeatHandle?type=4" target="mainFrame">管理职位信息</a></li>
	            </ul>
	        </li>
	        <li><span>ID信息管理</span>
	            <ul>
	                <li><a href="<%=path %>/Admin/CardAdd.jsp" target="mainFrame">添加ID类型</a></li>
	                <li><a href="<%=path %>/CardHandle?type=4" target="mainFrame">管理ID类型</a></li>
	            </ul>
	        </li>
	        <li><span>粉丝大咖管理</span>
	            <ul>
	                <li><a href="<%=path %>/FixedHandle?type=6" target="mainFrame">上下线设置</a></li>
	                <li><a href="<%=path %>/FixedHandle?type=4" target="mainFrame">在线信息管理</a></li>
	        	</ul>
	        </li>
	        <li><span>散粉管理</span>
	        	<ul>
	                <li><a href="<%=path %>/Admin/TempAdd.jsp" target="mainFrame">粉丝上线信息</a></li>
	                <li><a href="<%=path %>/TempHandle?type=4" target="mainFrame">粉丝下线信息</a></li>
	        	</ul>
            </li>
	        <li><span>系统功能操作</span>
	        	<ul>
	        ...
	        <li><span>粉丝大咖管理</span>
	            <ul>
	                <li><a href="<%=path %>/FixedHandle?type=6" target="mainFrame">上下线设置</a></li>
	                <li><a href="<%=path %>/FixedHandle?type=4" target="mainFrame">粉丝信息管理</a></li>
	        	</ul>
	        </li>
	        <li><span>散粉管理</span>
	        	<ul>
	                <li><a href="<%=path %>/Admin/TempAdd.jsp" target="mainFrame">粉丝上下线信息</a></li>
	                <li><a href="<%=path %>/TempHandle?type=4" target="mainFrame">粉丝上下线信息</a></li>
	        	</ul>
            </li>
	        <li><span>系统功能操作</span>
	        	<ul>
